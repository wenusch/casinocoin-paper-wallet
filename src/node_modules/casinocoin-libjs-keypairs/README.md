# casinocoin-libjs-keypairs

An implementation of casinocoin keypairs & wallet generation using
...
```
Derive a Casinocoin address from a public key.
...
## Generate a random Casinocoin address
