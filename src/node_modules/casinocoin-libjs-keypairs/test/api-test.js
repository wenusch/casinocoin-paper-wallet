...
const decodeSeed = require('casinocoin-libjs-address-codec').decodeSeed;
...
describe('api', () => {
    ...
    it('deriveNodeAddress', () => {
        const x = 'n9MhDFfzn1y1yYHPBzHdzUbbU1p28c66QRicKafAXW37wXDboAFo';
        const y = 'chDHiPbZSL69qHE6nWgiS29WbeqqWqixtE';
